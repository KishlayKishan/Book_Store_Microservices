package com.bridgelabz.orderservices.aopservice;
...
public class AOPService {
    ...
    @Before("execution(* com.bridgelabz.orderservices.controller.OrderController.*(..))")
    public void logBeforeV1(JoinPoint joinPoint) {
        log.info("Initiating API : " + joinPoint.getSignature().getName() + " ");
    }

    //logs method After hitting API
    @After("execution(* com.bridgelabz.orderservices.controller.OrderController.*(..))")
