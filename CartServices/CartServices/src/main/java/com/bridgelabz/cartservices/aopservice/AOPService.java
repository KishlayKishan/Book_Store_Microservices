package com.bridgelabz.cartservices.aopservice;
...
public class AOPService {
    ...
    @Before("execution(* com.bridgelabz.cartservices.controller.CartController.*(..))")
    public void logBeforeV1(JoinPoint joinPoint) {
        log.info("Initiating API : " + joinPoint.getSignature().getName() + " ");
    }


    @After("execution(* com.bridgelabz.cartservices.controller.CartController.*(..))")
